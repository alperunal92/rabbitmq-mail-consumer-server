  ...
  case 'register':
    message.context = {
      ...
      ...{
        ...
        mailIcon: mailInfo.mailIcon || 'https://github.com/alperunal92/rabbitmq-mail-consumer-server/blob/master/images/4.png',
  ...
  case 'forget':
    message.context = {
      ...
      ...{
        ...
        mailIcon: mailInfo.mailIcon || 'https://github.com/alperunal92/rabbitmq-mail-consumer-server/blob/master/images/5.png',
        webSiteLink: mailInfo.webSiteLink || 'http://localhost:3000',
